        ...
        try:
            ...
            if drop_table in table_list:
                ...
                if len(drss) == 0:
                    ...
                    data = {"code": 1, "message": "删除的工站有数据"}
                    data = json.dumps(data)
                    # db.close_connection(conn)
                    return HttpResponse(data)

            else:
                data = {"code": 1, "message": "删除的工站不在数据库内"}
                data = json.dumps(data)
                # db.close_connection(conn)
                return HttpResponse(data)
    ...
    def post(self, request):
        try:
            ...
            for response_data in response_datas:
                ...
                #     else:
                #         data = {"code": 1, "message": "该物料在物料清单里面的count没有数据,物料领料成功，但是person_matter里面的库存没有减"}
                #         logger.info("创建领料表失败，该物料在物料清单里面的count没有数据，物料领料成功，但是person_matter里面的库存没有减")
                #         data = json.dumps(data)
                #
                # else:
                #     data = {"code": 1, "message": "该物料在物料清单里面的count没有数据"}
                #     logger.info("创建领料表失败，该物料在物料清单里面的count没有数据，物料领料成功，但是person_matter里面的库存没有减")
                #     data = json.dumps(data)

            data = {"code": 0, "message": "创建领料表成功,物料清单的库存已经减去领料量"}
            logger.info("创建领料表成功")
            data = json.dumps(data)
            db.close_connection(conn)
...
class DeleteProcessDeal(View):
    ...
    def get(self, request):
        try:
            ...
            data = {"code": 0, "message": "操作成功", "data": ""}
            data = json.dumps(data)
            logger.info("删除工序中下的工站下添加的物料成功%s" )
            db.close_connection(conn)
            return HttpResponse(data)
...
class ProductTransitInfo(View):
    ...
    def get(self, request):
        try:
            ...
            if drs:
                ...
                result = json.dumps(result)
                logger.info("产品过站信息查询成功但是没有数据%s")
                db.close_connection(conn)
                return HttpResponse(result)
        except Exception as e:
            print(e)
    ...
    def post(self, request):
        ...
        try:
            ...
            # else:
            #     data = {"code": 1, "message": "操作失败,没有创建加工站,请先创建"}
            #     data = json.dumps(data)
            #     return HttpResponse(data)
            #
            # # 检查物料进入第一加工站时是否超过刚开始设定的产量，如果超过的话不让物料进入加工站
            #
            # sql_plan_count = """
            ...
            #     else:
            #         data = {"code": 1, "message": "操作失败,还没有建计划表，计划产量找不到"}
            #         data = json.dumps(data)
            #         return HttpResponse(data)
            # else:
            #     data = {"code": 1, "message": "操作失败,还没有建计划表，计划产量找不到"}
            ...
            # else:
            #     # data = "产品生产已经超过了原计划产量"
            #     data = {"code": 1, "message": "操作失败,产品生产已经超过了原计划产量"}
            #     data = json.dumps(data)
            #     return HttpResponse(data)
                ...
                if da_list:
                    ...
                    if des:
                        ...
                        if cureent_leader_id == None:
                            ...
                            data = {"code": 1, "message": "产品最后一站不是上级工站！"}
                            data = json.dumps(data)
                            logger.info("产品最后一站不是上级工站！")
                            return HttpResponse(data)
                                ...
                                if test_result=='PASS':
                                    ...
                                    data = {"code": 1, "message": "上级工站不合格，不可操作！"}
                                    data = json.dumps(data)
                                    logger.info("上级工站不合格，不可操作！")
                                    return HttpResponse(data)
    ...
    def get(self, request):
        try:
            ...
            if drs:
                ...
                data = {"code": 0, "message": "操作成功", "data": data_list}
                data = json.dumps(data)
                logger.info("返回物料的内码 名称 规格 长度成功%s")
                db.close_connection(conn)
            else:
                data = {"code": 0, "message": "没有找到数据", "data": []}
                data = json.dumps(data)
                logger.info("返回物料的内码 名称 规格 长度成功 但是没有找到数据%s")
                db.close_connection(conn)
            return HttpResponse(data)
...
class WorkStationGetData(View):
    ...
    def get(self, request):
        try:
            ...
            data = json.dumps(data)
            logger.info("工站的物料领料信息 安装数量成功%s")
            db.close_connection(conn)
...
class FinishedCodeGetMatterCodeID(View):
    ...
    def get(self, request):
        try:
            ...
            data = json.dumps(data)
            logger.info("成品码得到成品码下面的物料等信息成功%s")
            db.close_connection(conn)
            return HttpResponse(data)
        ...
        try:
            ...
            if len(drs) > 0 :
                if drs[0][0]:
                    ...
                    data_add_int["data"] = []
                    data_add_int["total"] = 0
                    result = {"code": 0, "message": "操作成功,但是没有数据", "data": data_add_int}
                    result = json.dumps(result)
                    db.close_connection(conn)
                    return HttpResponse(result)
            else:
    ...
    def post(self, request):
        ...
        try:
            ...
            if len(response_datas) > 0:
                ...
                data = {"code": 0, "message": "退料操作成功,退料已经存入物料清单查的库存"}
...
class OperationSystem(View):
    ...
    def get(self, request):
        try:
            ...
            result = {"code": 0, "message": "操作成功", "data": data_add_int}
            result = json.dumps(result)
            logger.info("OperationSystem>>>>操作成功%s")
            db.close_connection(conn)
            return HttpResponse(result)
                ...
                if data_list:
                    ...
                    if ds[0][0]:
                        ...
                        if work_code == enter_work_code:
                            if test_result == "PASS":
                                data = {"code": 0, "message": "产品周期最后一站合格,可以包装"}
                                data = json.dumps(data)
                                db.close_connection(conn)
                                return HttpResponse(data)
                            else:
                                data = {"code": 1, "message": "产品周期最后一站不合格"}
                                data = json.dumps(data)
                                db.close_connection(conn)
                                return HttpResponse(data)
                        else:
                            data = {"code": 1, "message": "生命周期的最后一站不是此工站的前一站"}
                            data = json.dumps(data)

                            return HttpResponse(data)

                    else:
                        data = {"code": 1, "message": "此站不是包装站，没有前一工站"}
                        data = json.dumps(data)
                        return HttpResponse(data)

                else:
                    data = {"code": 1, "message": "产品没有生命周期"}
                    data = json.dumps(data)
                    return HttpResponse(data)
    ...
    def get(self, request):
        try:
            ...
            if drs:
                ...
                result = {"code": 0, "message": "调取成功", "data": data_add_int}
                result = json.dumps(result)
                logger.info("不分页返回工站下 不良信息原因内码和名称成功%s")
                db.close_connection(conn)
                return HttpResponse(result)
        ...
        try:
            ...
            if un_tables:
                ...
                if data_list:
                    ...
                    result = json.dumps(result)
                    logger.info("根据不合格的成品码 返回他的不良原因码成功%s")
                    db.close_connection(conn)
                    return HttpResponse(result)
                else:
                    result = {"code": 0, "message": "此产品没有不良原因码", "data": data_list}
                    result = json.dumps(result)
                    logger.info("根据不合格的成品码 返回他的不良原因码成功, 此产品没有不良原因码%s" )
                    db.close_connection(conn)
                    return HttpResponse(result)
            else:
...
class AnalyseWorkStationInfo(View):
    ...
    def get(self, request):
        try:
            ...
            if len(drs_types) > 0:
                ...
                for work_type in data_type_list:
                    ...
                    if work_type == "加工":
                        ...
                        work_transit on work_station.work_code = work_transit.work_code where work_type = '测试'
                        """
                        ...
                        if len(drs) > 0:
                            for dr in drs:
                                ...
                                sql_pass = """
                                select count(*) from {0} 
                                where process_method = '产品维修' and out_time >= "{1}" and out_time <= "{2}"
                                """
                                sql_pass = sql_pass.format(select_table, start_time, end_time)
                                ...
                                sql_disassemble = """
                                select count(*) from {0} 
                                where process_method = '产品出站' and out_time >= "{1}" and out_time <= "{2}"
                                """
                ...
                result = {"code": 0, "message": "查询看板成功", "data" : data_list}
                result = json.dumps(result)
                logger.info("查询看板成功%s")
                return HttpResponse(result)

            else:
                result = {"code": 0, "message": "work_station里面还没有数据（未建工站表）", "data": data_list}
                result = json.dumps(result)
                logger.error("work_station里面还没有数据（未建工站表）%s")
                return HttpResponse(result)
            ...
            result = {"code": 1, "message": "操作失败", "data": e}
            result = json.dumps(result)
            logger.error("各个工站的合格数和不合格数进站出站等信息失败%s" % e)
            return HttpResponse(result)
...
class FromDataModel(View):
    ...
    def get(self, request):
        try:
            ...
            result = {"code": 0, "message": "数据已经导出", "file_path": file_path}
            result = json.dumps(result)
            return HttpResponse(result)

        except Exception as e:
            print(e)
            result = {"code": 1, "message": "数据导出操作失败"}
            result = json.dumps(result)
            logger.error("数据导出操作失败")
            return HttpResponse(result)
...
class downloads(View):
    ...
    def get_files(self, request, file_path):
        ...
        from django.utils.http import urlquote  # 包含中文文件名引入
...
class FinishedProductOut(View):
    def get(self, request):
        try:
            ...
            if len(dr_checks) > 0:
                data = {"code": 1, "message": "此包装码已经发货,不能重复扫"}
                data = json.dumps(data)
                ...
                data = {"code": 0, "message": "操作成功", "data": reponse_data}
...
class GetProductOutInfo(View):
    def get(self, request):
        try:
            ...
            print(e)
            data = {"code": 1, "message": "查询产品出库失败"}
            data = json.dumps(data)
            logger.error("查询产品出库失败")
            ...
            if len(dr_types) > 0:
                if dr_types[0][1] == "加工":
                    ...
                    if len(dr_infos) > 0:
                        ...
                        data = {"code": 1, "message": "此站里面没有此产品码,请检查"}
                        data = json.dumps(data)
                        return HttpResponse(data)

                elif dr_types[0][1] == "测试":
                    sql_table = """
                    ...
                    if len(dr_tables)> 0:
                        if dr_tables[0][0]:
                            ...
                            if len(dr_infos) > 0:
                                ...
                                data = {"code": 1, "message": "测试工站没有自定义建测试表,找不到它的表"}
                                data = json.dumps(data)
                                return HttpResponse(data)
                    ...
                    if len(dr_infos) > 0:
                        ...
                        data = {"code": 1, "message": "维修站里面没有此产品码,请检查"}
                        data = json.dumps(data)
                        return HttpResponse(data)

                elif dr_types[0][1] == "包装":
                    # table_one = "modify_in_workstation"
                    ...
                    if len(dr_infos) > 0:
                        ...
                        data = {"code": 1, "message": "包装站里面没有此产品码,请检查"}
                        data = json.dumps(data)
                        return HttpResponse(data)
            else:
                data = {"code": 1, "message": "工站表里面没有此工站内码，请检查"}
                data = json.dumps(data)
                return HttpResponse(data)
        ...
        try:
            ...
            if len(drs) > 0:
                if drs[0][0]:
                    ...
                    data_add_int["data"] = []
                    data_add_int["total"] = 0
                    result = {"code": 0, "message": "操作成功,没有数据", "data": data_add_int}
                    result = json.dumps(result)
                    logger.info("查询生产领料成功,但是没有数据")
                    return HttpResponse(result)
